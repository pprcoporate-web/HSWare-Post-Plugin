# HSWare Post — Public Submission v3.2
...
## Tools
1. `get_hsware_contract` — read-only; returns a compact fast-default generation contract, or the full specification only when strict mode is explicitly requested.
...
## Before submission
- Deploy v3.2 and verify `/health`, `/privacy`, `/terms`, `/support`, and `/mcp`.
